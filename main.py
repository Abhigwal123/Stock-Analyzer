...
def get_data():
    ...
    try:
        ...
        data = pd.read_csv('{}.csv'.format(ticker))
        latest_data = data.tail(1).to_dict(orient='records')
        return jsonify(success=True, company_name=company_name, data=latest_data)
